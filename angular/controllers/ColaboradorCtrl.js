  ...
  ColaboradorServices
    ...
    $scope.gridOptions = {
      ...
      columnDefs: [ 
        ...
        { field: 'fecha_nacimiento', name: 'fecha_nacimiento', displayName: 'Fecha de Nacimiento', minWidth: 100, enableColumnMenus: false, enableColumnMenu: false} 
      ],
...
app.factory("ColaboradorFactory", function($uibModal, pinesNotifications, blockUI, ColaboradorServices) { 
  var interfaz = {
