...
<div class="modal-body">  
	<form class="row" name="formTipoDocumento">
		<div class="form-group col-md-6 mb-md">
			...
			<input type="text" class="form-control input-sm" ng-model="fData.descripcion_tdm" placeholder="Descripción tipo documento" required tabindex="60" />
		</div>
		<div class="form-group col-md-6 mb-md">
			<label class="control-label mb-n"> Abreviatura: <small class="text-danger">(*)</small> </label>
			<input type="text" class="form-control input-sm" ng-model="fData.abreviatura_tdm" placeholder="Ingrese abreviatura" required tabindex="70" />
		</div>
		<div class="form-group col-md-6 mb-md">
			<label class="control-label mb-n"> Porcentaje: <small class="text-danger">(*)</small> </label>
			<input type="text" class="form-control input-sm" ng-model="fData.porcentaje_imp" placeholder="Ingrese porcentaje" required tabindex="70" />
		</div>
