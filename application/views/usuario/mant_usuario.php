...
<div class="modal-body">  
	<form class="row" name="ColaboradorCtrl">
		<div class="form-group col-md-6 mb-md">
			...
			<input type="text" class="form-control input-sm" ng-model="fData.username" placeholder="Ingrese usuario" required tabindex="40" />
		</div>
    	<div class="form-group col-md-6 mb-md">
    	...
    	<div class="form-group col-md-6 mb-md">
			...
			<input type="text" class="form-control input-sm" ng-model="fData.password_view" placeholder="Registre contraseña" required tabindex="50" />
		</div>
    	<div class="form-group col-md-6 mb-md">
			<label class="control-label mb-n"> Repita la contraseña: <small class="text-danger">(*)</small> </label>
			<input type="text" class="form-control input-sm" ng-model="fData.password" placeholder="Repita contraseña" required tabindex="50" />
		 </div>
		</div>
	</form>
</div>
