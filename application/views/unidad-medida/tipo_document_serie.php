...
<div class="modal-body">  
	<form class="row" name="formTipo_documento_serie">
...
<div class="modal-footer">
    <button class="btn btn-primary" ng-click="aceptar(); $event.preventDefault();" ng-disabled="formTipo_documento_serie.$invalid">Aceptar</button>
