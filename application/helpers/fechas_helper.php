...
function get_rangohoras_am_pm($start, $end, $incluye = false)
{ // TRUE: hora final incluida; FALSE: no incluye la hora final
    // var_dump($end);
...
function darFormatoFecha($fechaSQL)
{
    ...
    $shortMonthArray = ["", "Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Set", "Oct", "Nov", "Dic"];
    $shortDayArray = ["", "Lun", "Mar", "Mie", "Jue", "Vie", "Sab", "Dom"];
...
{
    $shortMonthArray = ["", "Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Set", "Oct", "Nov", "Dic"];
    $shortDayArray = ["", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado", "Domingo"];
    if ($fechaSQL == 0) {
        return "";
    }
    $fechaUT = strtotime($fechaSQL); // obtengo una fecha UNIX ( integer )
...
function darFormatoDiaFecha($fechaSQL)
{
    ...
    $shortMonthArray = ["", "Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Set", "Oct", "Nov", "Dic"];
    $longDayArray = ["", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado", "Domingo"];
    $fechaUT = strtotime($fechaSQL); // obtengo una fecha UNIX ( integer )
    $D = date('j', $fechaUT); //obtiene los dias en formato 1 - 31
    $d = date('N', $fechaUT); //obtiene los dias en formato 1 - 7
    $m = (int)date('m', $fechaUT);
...
function dentro_de_horario($hms_inicio, $hms_fin, $hms_referencia = null)
{ // v2011-06-21
